...
//         // Check if data is an array, if not, initialize an empty array
...
//         // Find if there's an Order with the given email
...
//             res.json({ success: true });
//         } else {
//             // If the order exists, update it by pushing new data
